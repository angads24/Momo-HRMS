...
async function bootstrap() {
  ...
  const swaggerConfig = new DocumentBuilder()
    ...
    .setDescription(
      'Geofence & Office Polygon Boundary Microservice for the Smart Employee Attendance & Management System',
    )
    .setVersion('1.0')
  ...
  Logger.log(`Geofence Service listening on port ${port} (prefix: /${apiPrefix})`, 'Bootstrap');
